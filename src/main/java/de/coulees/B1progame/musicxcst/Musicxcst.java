...
public final class Musicxcst implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        PayloadTypeRegistry.clientboundPlay().register(UploadedMusicListPayload.TYPE, UploadedMusicListPayload.CODEC);
        ...
        PayloadTypeRegistry.serverboundPlay().register(UploadedMusicListRequestPayload.TYPE, UploadedMusicListRequestPayload.CODEC);
        ...
        ServerPlayNetworking.registerGlobalReceiver(UploadedMusicListRequestPayload.TYPE, (payload, context) -> LIBRARY.sendUploadedMusicList(context.player()));
